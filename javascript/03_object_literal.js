 ...
 * var object = {
 *    "name": "장민창",
 *    "Skills": ["java", "kotlin", "scala", "rust", "c++", "c#", "javascript", "ecmascript", "typescript", "sql", "pl/sql", "python", "ruby"]
 *    "liveInKorea": true,
 *    true : "맞다",
 *    [1,2,3] : values...,
 *    hello: function() {
 ...
 *      object.hello();
 *      var country = object.address.country;
 *
 *  2. "[]"를 이용하는 방법
 *      var key = "Skills";
...
var member = {
  ...
  administrator: true,
  password: "admin1234",
  authorization: ["admin", "operator", "user", "mamager"],
